...
# write.csv(grid_search, "Tables/Grid_Search/THg_grid_srch.csv", row.names = F)
...
# Do either nodesize=1, mtry=0.5 (0.644) or nodesize=5, mtry=2/3 (0.643)
...
# # saveRDS(rf.cpi9999, "Model_Output/THg/CPI9999_rf_full_mtryHalf_ntree5000_node1_sd36.rds")
# rf.cpi9999 <- readRDS("Model_Output/THg/CPI9999_rf_full_mtryThird_ntree5000_node1_sd36.rds") #
# 
