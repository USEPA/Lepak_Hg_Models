...
dir.create(paste0(fig_dir, "EXTRA/LOESS/D202/"), recursive=T, showWarnings = FALSE) 
dir.create(paste0(fig_dir, "EXTRA/LOESS/D199/"), recursive=T, showWarnings = FALSE) 
dir.create(paste0(fig_dir, "EXTRA/LOESS/D200/"), recursive=T, showWarnings = FALSE) 
