...
dir.create(paste0(fig_dir, "EXTRA/LOESS_SKATER20/D202/"), recursive=T, showWarnings = FALSE) 
dir.create(paste0(fig_dir, "EXTRA/LOESS_SKATER20/D199/"), recursive=T, showWarnings = FALSE) 
dir.create(paste0(fig_dir, "EXTRA/LOESS_SKATER20/D200/"), recursive=T, showWarnings = FALSE) 
