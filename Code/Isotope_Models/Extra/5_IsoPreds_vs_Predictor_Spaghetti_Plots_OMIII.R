...
dir.create(paste0(fig_dir, "EXTRA/LOESS_OMIII/D202/"), recursive=T, showWarnings = FALSE) 
dir.create(paste0(fig_dir, "EXTRA/LOESS_OMIII/D199/"), recursive=T, showWarnings = FALSE) 
dir.create(paste0(fig_dir, "EXTRA/LOESS_OMIII/D200/"), recursive=T, showWarnings = FALSE) 
